...
%%
param=load_tracking_param_from_pieces('Y:\mDrives\storage4\Guillermo\segmentation_testing\output\testOutputTracking\img_segmentation_parameters_');
...
%         end
    ...
    tic
    % input image path
    s_img1=imread(['Y:\mDrives\storage4\Guillermo\segmentation_testing\output\testOutputTracking\segments\img_' num2str(time,'%.03d') '.tif']);
...
%         tic
        ...
        l_img1=bwmorph(l_img1,'skel',inf); %erode to 1 thick lines.
        % vertices are in the set of pixels with > 2 1s in the neighbourhood.
...
%% saving            
file_name=[param.seq_name '_segmentation_parameters_vertices_1_200_'];
