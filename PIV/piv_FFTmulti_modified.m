function [xtable, ytable, utable, vtable, typevector] = piv_FFTmulti_modified (image1,image2,interrogationarea, step, subpixfinder, mask_inpt, roi_inpt,passes,int2,int3,int4,imdeform)
% This is core function of PIVlab. See documentation of PIVlab for more
% details.
%profile on
